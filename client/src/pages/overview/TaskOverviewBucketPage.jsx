  ...
  return (
    <div className="flex flex-col h-full">
      <div className="flex items-center gap-3 px-6 py-4 border-b border-[#E8E6E0] bg-white flex-shrink-0">
        ...
        <div>
          <h1 className="text-[15px] font-semibold text-[#1A1A1A]">Project Overview — By Bucket</h1>
          {!loading && !error && (
...
export default TaskOverviewBucketPage;
